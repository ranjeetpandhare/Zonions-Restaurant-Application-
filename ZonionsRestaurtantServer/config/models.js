...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  beforeUpdate: function (values, next) {
    if (!values.updatedAt) values.updatedAt = new Date().toUTCString();
    // else if (values.updatedAt == 'no_update') delete values.updatedAt;
    else values.updatedAt = new Date(values.updatedAt).toUTCString();
    next();
  },
  beforeCreate: function (values, next) {
    if (!values.updatedAt) values.updatedAt = new Date().toUTCString();
    else values.updatedAt = new Date(values.updatedAt).toUTCString();
    if (!values.createdAt) values.createdAt = new Date().toUTCString();
    else values.createdAt = new Date(values.createdAt).toUTCString();
    next();
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'EwWguqzOvWzo18D7bkA8iHQQ/e9N3t0s87Nhb8XNFEA='
  },
